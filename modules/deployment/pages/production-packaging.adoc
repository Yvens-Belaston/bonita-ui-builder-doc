...
The xref:@bonita:runtime:healthcheck-mechanism.adoc[Bonita healthcheck] is a mechanism used to monitor the health and
availability of Bonita services in production environments.
...
You can override and configure all xref:installation:ui-builder-docker-installation.adoc#environment-variables[environment
variables].
