...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-adapt-ui-to-viewport-size.adoc, 2025.1@bonita:applications:ui-builder/how-to-adapt-ui-to-viewport-size.adoc, 2025.2@bonita:applications:ui-builder/how-to-adapt-ui-to-viewport-size.adoc
...
export default {
     ...
     *
     * Configure this function to run "On page load" (see Step 3).
     */
    redirectIfMobile() {
...
=== Step 3 — Set the function to run On Page Load
...
=== Step 4 — Prepare the mobile destination
...
Set `redirectByDevice` to run *On Page Load* following the same process as Step 3.
