...
If you deploy Bonita Runtime Tomcat bundle instead of the docker container, make sure you xref:@bonita:identity:ssl
.adoc#_tomcat_and_ssl_offloading[activate the RemoteIpValve].
